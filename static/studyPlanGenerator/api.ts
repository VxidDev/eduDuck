...
export async function generateStudyPlan(body: StudyPlanBody): Promise<StudyPlanResponse> {
...
export async function importPlan(file: File): Promise<ImportPlanResponse> {
    const formData = new FormData();
