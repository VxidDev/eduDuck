...
export const QuestionSelector = document.getElementById("questionCount") as HTMLSelectElement;
export const APIModeSelector = document.getElementById("apiMode") as HTMLSelectElement;
export const QuizDifficulty = document.getElementById("difficulty") as HTMLSelectElement;
