...
import { NoteInput, Submit, TextInputs, ApiKeyInput, CustomModelInput, LanguageSelector, APIModeSelector, FreeUsage, FreeUsageText, ApiKeyInputParent } from "./ui.js";
...
async function handleFileUpload(file) {
    ...
    try {
        ...
        const LINEHEIGHT = 25;
        NoteInput.style.height = `${Math.min(NoteInput.scrollHeight, MAXLINES * LINEHEIGHT + 35)}px`;
        hideStatus();
    }
    catch (error) {
