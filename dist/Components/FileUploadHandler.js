export function InitFileUploads({ selector = '.file-input', wrapperSelector = '.file-upload-wrapper', displaySelector = '.fileButton', defaultText = 'No file selected', onRegularFile, onImportFile }) {
