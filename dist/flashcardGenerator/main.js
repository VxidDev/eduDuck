...
import { NoteInput, Submit, TextInputs, ApiKeyInput, CustomModel, CustomModelInput, LanguageSelector, APIModeSelector, AmountSelector, FreeUsage, FreeUsageText, ApiKeyInputParent } from "./ui.js";
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    Submit.addEventListener("click", async () => {
        ...
        ValidateInput(notes, apiKey, modelVisible, model, document.querySelector('.status-text'), words.length, requiresApiKey);
